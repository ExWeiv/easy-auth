...
exports.discord = exports.github = exports.google = exports.facebook = void 0;
...
exports.discord = {
    redirectURL: discord_1.default.redirectURL,
    userAuth: discord_1.default.userAuth
};
exports.default = {
    facebook: exports.facebook,
    google: exports.google,
    github: exports.github,
    discord: exports.discord
};
